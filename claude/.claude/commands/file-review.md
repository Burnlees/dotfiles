...
## Task 1: Analyze File
Use the Read tool to read the file specified by `$ARGUMENTS` and analyze the code using Claude Code's file analysis capabilities.
...
Review the code present in the file, analyse and think hard before contructing you've review to meet the below guidlines.
...
- Automatically detect the primary language(s) from the file
...
Present the code review to me, highlight key areas of the file and suggesting improvements and why.
...
- Include file path and modification date for reference
